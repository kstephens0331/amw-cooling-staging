      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 text-sm md:text-base bg-gray-50 p-6 rounded-lg shadow-md">
            ...
            <p className="mb-2"><strong>Phone:</strong> <a href="tel:+19363311339" className="text-blue-600 hover:underline">(936) 331-1339</a></p>
            <p className="mb-2"><strong>Email:</strong> <a href="mailto:admin@amwairconditioning.com" className="text-blue-600 hover:underline">admin@amwairconditioning.com</a></p>
